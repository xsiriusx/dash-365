...
SoftwareSerialWithHalfDuplex XIAOMI_Port(comPin,comPin,false,false);
...
void esccontrol(){
    ...
    char brake = map(control, 184, 800, 0x26, 0xC2);
    motor[8] = brake; 
    motor1[8] = brake;
    
    int value = analogRead(A4);
    char speed = map(value, 170, 1024, 0x26, 0xC2);
    motor[7] = speed;
    motor1[7] = speed;
    ...
    XIAOMI_Port.write(motor, sizeof(motor)); delay(10);
    XIAOMI_Port.write(motor, sizeof(motor)); delay(10);
    XIAOMI_Port.write(motor, sizeof(motor)); delay(10);
    XIAOMI_Port.write(motor, sizeof(motor)); delay(10);
    XIAOMI_Port.write(motor1, sizeof(motor1)); delay(10);
